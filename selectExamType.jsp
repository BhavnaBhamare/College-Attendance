			...
			<div class="x_panel" id="op">
				...
				<div class="x_content">
					<form class="form-horizontal form-label-left"
							action="updateMarks.jsp" method="post">
							<br>
							...
							<button type="submit"
								...
								data-toggle="modal" data-target="#myModal" style="width: 110px;">Update Marks</button>
							&nbsp;
							<button type="reset" class="btn btn-danger" style="width: 90px;">Clear</button>
							&nbsp; 
								<button type="button" id="btncancel" onclick="refresh()"
									class="btn btn-success" style="width: 100px;">View Report</button>
