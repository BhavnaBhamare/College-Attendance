		...
		<div class="row">
			<div class="col-md-10 col-sm-6 col-xs-12">
				<div class="x_panel">
					...
					<form class="form-horizontal form-label-left" action="AdminViewTimeTable"
							method="post">


							<span class="section">View TimeTable Details</span>
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									...
									<input type="submit" class="btn btn-success" value="View TimeTable">
								</div>
							</div>
						</form>
					</div>
