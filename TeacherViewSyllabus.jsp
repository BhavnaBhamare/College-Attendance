			...
			<div class="x_content">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<form action="ViewSyllabus" method="post" id="demo-form2"
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Select
							Syllabus Subject <span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							

							<select name="SubjectName"	class="form-control col-md-7 col-xs-12">
...
<table  class="table table-striped table-responsive" border="1">
 ...
 <thead>
      ...
      <th>Syllabus Modules</th>
       <th>Syllabus Practical</th>
        <th>Syllabus Chapter</th>
          <th>Syllabus Total Hours</th>
...
<c:forEach items="${sessionScope.list1}" var="l" >
	   ...
	   <c:out value="${l.syllabusModules } "/><br>
	 </c:forEach>
	 </td>
	  <td rowspan="9">
<c:forEach items="${sessionScope.list1}" var="l" >
      
	   <c:out value="${l.syllabusPracticals } "/><br>
	 </c:forEach>
...
<c:forEach items="${sessionScope.list1}" var="l" >
	   ...
	   <c:out value="${l.syllabusChapters } "/><br>
	 </c:forEach>
...
<c:forEach items="${sessionScope.list1}" var="l" >
	   ...
	   <c:out value="${l.syllabusTotalHours } "/><br>
	 </c:forEach>
