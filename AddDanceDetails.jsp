		...
		<div class="row">
			<div class="col-md-10 col-sm-6 col-xs-12">
				<div class="x_panel">
					...
					<form class="form-horizontal form-label-left" action="AddDance"
							method="post">


							<span class="section">Add Dance Details</span>
						...
						<div class="item form-group" style="margin-right:-80px; ">
							 ...
							 <div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12">Dance Type<span class="required">*</span>
								</label>
								<div class="col-md-8 col-sm-8 col-xs-12">
									<select class="select2_single form-control" tabindex="-1"
										...
										<option value="Yangko">Yangko
											</option>
										<option value="	Belly">Belly</option>
										<option value="Kathak">Kathak</option>
										<option value="	Gangnam">Gangnam</option>
										<option value="Break Dance"> Break Dance
										</option>
