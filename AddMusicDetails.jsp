		...
		<div class="row">
			<div class="col-md-10 col-sm-6 col-xs-12">
				<div class="x_panel">
					...
					<form class="form-horizontal form-label-left" action="AddMusic"
							method="post">


							<span class="section">Add Music Details</span>
						...
						<div class="item form-group" style="margin-right:-80px; ">
							 ...
							 <div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12">Instrument Type<span class="required">*</span>
								</label>
