...
<%
	...
	Enrolledstudents en=bl.fetchStudentEnrolledId(apId);
	Transportservicereq tr = bl.fetchTStudentApllicationId(en);
	System.out.println(tr.getEnrolledstudents().getApplicationforadmission().getApplicantFirstName());
	HttpSession s = request.getSession();
	s.setAttribute("GoForPayment", tr);
	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h2>List of Student Application For Transportation</h2>
			</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_panel">
							<div class="x_content">
								<form action="AccountantTakingTransportFees" method="post">
									...
									<div class="form-group ">
										<label>Registration Id&nbsp;</label> <u><c:out
												value="${GoForPayment.enrolledstudents.applicationforadmission.applicationId}" /></u>
									</div>
									<div class="form-group ">
										<label>Student Name&nbsp;</label> <u><c:out
												value="${GoForPayment.enrolledstudents.applicationforadmission.applicantFirstName}" /></u>
									</div>

									<div class="form-group">
										<label>Course&nbsp;</label> <u><c:out
												value="${GoForPayment.enrolledstudents.applicationforadmission.course.courseName}" /></u>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<label>Branch&nbsp;</label> <u><c:out
												value="${GoForPayment.enrolledstudents.applicationforadmission.branch.branchName}" /></u>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<table
										...
										<tbody>
											...
											<tr class="even pointer">
												...
												<td class=" ">1</td>
												<td class=" ">Transportation Fees</td>
												<td class=" "><c:out value="6000" /></td>
											</tr>
										</tbody>
									</table>
									 ...
									 <div class="row" style="float: right; margin-right: 127px;">
										...
										%>
 --%>
									Total Amount:6000 <input type="hidden" value="6000"
