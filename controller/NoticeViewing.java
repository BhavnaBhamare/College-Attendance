...
/**
 * Servlet implementation class NoticeViewing
 */
@WebServlet("/NoticeViewing")
public class NoticeViewing extends HttpServlet {
	...
	//	String noticDesc = request.getParameter("noticeDescription");
       ...
       // String msg="Record has been Updated";
		...
		response.sendRedirect("TeacherViewNotice.jsp");
	}
