...
<%
	...
	s.setAttribute("GoForPayment", ap);
	int c = ap.getCourse().getCourseId();
	Course c1 = bl.FetchCourseId(c);
	Coursefees cf = bl.FetchCourseFeesId(c1);
	HttpSession s2 = request.getSession();
	s2.setAttribute("CourseFees", cf);
%>
<%
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_panel">
							<div class="x_content">
							<form action="AccountantTakingAdmitionFees" method="post">
								<label>Date&nbsp;</label> <u><c:out value="${currentDate}" /></u>

								<u style="float: right;">1</u> <label style="float: right;">Reciept
									No.&nbsp;</label> <br> <br>
								<div class="form-group ">
									<label>Application Id&nbsp;</label> <u><c:out
											value="${GoForPayment.applicationId}" /></u>
								</div>
								<div class="form-group ">
									<label>Student Name&nbsp;</label> <u><c:out
											value="${GoForPayment.applicantFirstName}" /></u>
								</div>

								<div class="form-group">
									<label>Course&nbsp;</label> <u><c:out
											value="${GoForPayment.course.courseName}" /></u>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<label>Branch&nbsp;</label> <u><c:out
											value="${GoForPayment.branch.branchName}" /></u>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<table
									...
									<tbody>
										<tr class="even pointer">
											...
											<td class=" ">1</td>
											<td class=" ">Deposite</td>
											<td class=" ">10000.0</td>
										</tr>
										<tr class="even pointer">

											<td class=" ">2</td>
											<td class=" ">Semester-1 Fees</td>
											<td class=" "><c:out value="${CourseFees.fees}" /></td>
										</tr>
									</tbody>
								</table>
								...
								<div class="row" style="float: right; margin-right: 127px;">
									...
									Total Amount:${Total} <input type="hidden" value="${Total}"
