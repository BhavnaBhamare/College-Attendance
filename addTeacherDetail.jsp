...
<div class="right_col" role="main">
	...
	<%
		session.removeAttribute("MsgTeacher");
	%>
		...
		<div class="x_panel" id="op">
			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left"
					action="AddTeacherDetailServ" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherFirstName" required
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherMiddleName" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherLastName" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherEmailId" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherPassword" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							...
							<input type="radio" name="tcherGender" value="male" checked>
							male <input type="radio" name="tcherGender" value="female">
							female<br>
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherPhoneNumber" maxlength="10"
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherQualification" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="">
							Previous College Name<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherPreviousCollegeName" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherExperience" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="tcherSalary" required
								class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<br>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<textarea name="tcherPeremanantAddress" cols="10" rows="5"
