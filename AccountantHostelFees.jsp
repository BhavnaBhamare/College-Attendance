...
<%
	...
	List<Hostelregistration> ApprovedStudentsList = bl.AprovalListForHostelStudents();
					...
					<form class="form-horizontal form-label-left"
						...
						<table class="table table-striped">
							...
							<c:forEach items="${sessionScope.ApprovedStudentsList}" var="ls">
								...
								<tr>
									<td><c:out value="${ls.applicationforadmission.applicationId}" /></td>
									<td><c:out value="${ls.applicationforadmission.applicantFirstName}" /></td>
									

									<td><a
										href="AccountantTakingHostelFees.jsp?AID=${ls.applicationforadmission.applicationId}">Go
											For Payment</a></td>
								</tr>
							</c:forEach>
						</table>
